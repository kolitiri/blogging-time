...
Sounds simple, right? Same product, newer version. Sounds like a no-brainer.
...
As it turns out, the new version of the CMS was so far ahead of the old one that would require significant effort to upgrade.
...
The only issue they had not considered was that there were teams, like my friend's, which were responsible for hundreds of pages worth of content, with links to other pages and images.

So the migration would be technically a nightmare and the risk of messing up pretty high.
...
But everything I found was pointing to the same conclusion: Yes, it can be done, but it might not worth the effort from a business perspective.
...
But the thing is.. I still couldn't let go, so I started thinking it over.
...
The plan was simple:
1. Install Playwright MCP in Claude
...
After a few days I managed to sit down with my friend again, this time infront of her laptop.
...
Not much of a surprise to me but the look on my friend's face was priceless. She was looking at me like I was a magician of some sort.
...
So we tempered the prompt a bit, pointed Claude to the right directory in the CMS and there you go.
...
I don't consider myself a hard core engineer by any means. However, I do take pride of my work and I usually hate solutions that are not elegant or efficient. Let alone half baked and unsafe.

We have all spent a great amount of time and effort to learn and master our craft, thus solutions of this nature feel more like a gimmick.
